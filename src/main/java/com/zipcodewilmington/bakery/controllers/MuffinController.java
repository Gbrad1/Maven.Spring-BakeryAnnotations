...
public class MuffinController {
    ...
    @GetMapping("/muffins") // Crud operation R - Get
    public ResponseEntity<Iterable<Muffin>> index() {
        return new ResponseEntity<>(service.index(), HttpStatus.OK);
    }

    @GetMapping("/muffins/{id}") // Crud operation R - Get
    public ResponseEntity<Muffin> show(@PathVariable Long id) {
        return new ResponseEntity<>(service.show(id), HttpStatus.OK);
    }

    @PostMapping("/muffins") // Crud operation C - Post
    ...
    @PutMapping("/muffins/{id}") // Crud operation U - Put
    ...
    @DeleteMapping("/muffins/{id}") // Crud operation D - Delete
